<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($name_2) OR empty($subject) OR empty($message) OR empty($phone) OR empty($address) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
